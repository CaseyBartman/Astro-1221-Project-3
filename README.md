...
- Lauren:
 ...
 - Andrew:
 -  I also used AI more for this project as I was not very familiar with fitting data sets or working with statistical ideas like Chi Squared, but I mostly tried to keep the AI to the specific questions I had while attempting to do what I could at the structural level myself. I also tried to make sure I understood the output of the AI and spent a lot of time haggling to get the code that I wanted. As for the astrophysics portion I used AI to explain concepts I did not understand, which was most of them because I have not taken an astro course before.
